...
- Scan kernel exact knobs
- Per-candidate validation cost
- Eval phase and EVAL_FAST_REJECT
- Overall pipeline speedup
- Recommended settings
- Batch/large-comb exactness
- single_pass vs full_first
- Chunk sizing and methodology
