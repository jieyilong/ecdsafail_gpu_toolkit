...
- GPU_BATCH_INV batch inversion
- GPU_COMB_BITS larger scalar-multiplication tables
- GPU_GCD_MODE check ordering
- GPU_WAVE threads per nonce wave
- GPU_FAN_BITS nonce-fan
- EVAL_FAST_REJECT eval early-exit
